FROM ubuntu:14.04
MAINTAINER Kevin Kevin Nordloh
...
nginx php5-fpm php5-mysql php-apc pwgen python-setuptools \
curl git unzip openssh-server openssl

# Wordpress Requirements
RUN apt-get -y install php5-curl php5-gd php5-intl php-pear \
