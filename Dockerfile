...
# Basic Requirements
RUN apt-get -y install mysql-server mysql-client nginx php7.0-cli php7.0-fpm php7.0-common php7.0-mysql php-apcu pwgen python-setuptools curl git unzip openssh-server openssl vim
